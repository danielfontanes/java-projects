	...
	public static void main(String[] args) {
		...
		while(true) {
			if(primeraPartida==true) {
				System.out.println("Bienvenido al juego de adivina un número:");
			...
			System.out.println("1. Nivel 1. El número generado está entre 1 y 15. Tienes 3 intentos.");
			System.out.println("2. Nivel 2. El número generado está entre 1 y 30. Tienes 4 intentos.");
			System.out.println("3. Nivel 3. El número generado está entre 1 y 50. Tienes 5 intentos.");
			...
			if(seleccion==1) {
				...
				while(intentos>0) {
					...
					if(numeroRandom == Integer.parseInt(lector.nextLine())) {
						...
						intentos--;
						System.out.println("No acertaste el número. Te quedán " + intentos + " intentos.");
					}
					if(intentos==0) {
						System.out.println("El número era el " + numeroRandom);
						System.out.println("La próxima vez seguro que aciertas!!");
					}
				}
			}
			//Nivel 2
			if(seleccion==2) {
				System.out.println("Seleccionaste el Nivel 2. Parece una buena decisión.");
