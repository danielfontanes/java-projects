...
public class Extra1 {
	...
	public static void main(String[] args) {
		//HUNDIR LA FLOTA
		//Matriz que utilizo para que el programa sepa donde están los barcos
		...
		while(true) {			
			...
			while(counter < 10) {
				...
				//Compruebo que esa posición no esté ocupada por un 1
			...
			System.out.println("Para que puedas ver el mapa en el que se generan los barcos el cual no se le mostraría al jugador:");
			for (int i = 0; i < map.length; i++) {
