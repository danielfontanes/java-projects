...
public abstract class Ejercicio1 {
	...
	public static void main(String[] args) {
		...
		while(true) {
			//Lleno array de números aleatorios entre 0 y 100
			...
			System.out.println("a. Mostrar valores superiores a un número introducido.");
			...
			System.out.println("d. Mostrar por pantalla el primer valor inferior a un número introducido.");
			System.out.println("e. Mostrar por pantalla los valores que sean primos.");
			System.out.println("f. Mostrar el valor máximo, el mínimo del array, el segundo más alto y el segundo más pequeño junto con las posiciones que ocupan.");
			...
			if(String.valueOf('a').equals(seleccion)) {
				...
				System.out.println("Introduce el número que desea:");
			...
			if(String.valueOf('f').equals(seleccion)) {
				...
				for(int i=0;i<numeros.length;i++) {
					...
					if(numeros[i]>valorMaximo) {
						//Para que si el valor maximo deja de ser el valor máximo pase a ser el segundo valor máximo
					...
					if(numeros[i]<valorMinimo) {
						//Para que si el valor mínimo deja de ser el valor mínimo pase a ser el segundo valor mínimo
				...
				System.out.println("El valor máximo es: " + valorMaximo + ", con la posición: " + posicionValorMaximo);
				System.out.println("El segundo valor máximo es: " + segundoValorMaximo + ", con la posición: " + posicionSegundoValorMaximo);
				System.out.println("El valor mínimo es: " + valorMinimo + ", con la posición: " + posicionValorMinimo);
				System.out.println("El segundo valor mínimo es: " + segundoValorMinimo + ", con la posición: " + posicionSegundoValorMinimo);
